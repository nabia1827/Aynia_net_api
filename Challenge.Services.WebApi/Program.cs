...
Log.Logger = new LoggerConfiguration()
    ...
    .WriteTo.Console()
    .ReadFrom.Configuration(builder.Configuration) // Cargar configuraci�n desde appsettings.json
    .CreateLogger();
...
builder.Services.AddCors(options => options.AddPolicy("policyApiAynia",
